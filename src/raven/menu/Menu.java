...
public class Menu extends JPanel {
    ...
    private final String headerName = "BeePhone";
    ...
    protected void runEvent(int index, int subIndex) {
        ...
        if (index == 4 || index == 3) {
        if (ShareUtil.USER.getChucvu().equals("Nhân Viên")) {    
            JOptionPane.showMessageDialog(null, "Nhân viên không có quyền truy cập.");
