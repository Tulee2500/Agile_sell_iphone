...
import raven.application.form.other.GiamGia;
import raven.application.form.other.HoaDon;
import raven.application.form.other.KhachHang;
import raven.application.form.other.NhanVien;
...
//                }
                ...
                Application.showForm(new GiamGia());
            }
            else if(index == 4){
